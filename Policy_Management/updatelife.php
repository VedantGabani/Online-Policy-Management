...
if ($result->num_rows > 0) {
	...
	$sql = "UPDATE life SET name= '$name' , age= '$age' , habit= '$habit', income= '$annual'  WHERE   pid = '$pid' ";
...
<b>
    ...
    <div class="container">
      <form action="updatelife.php" method = "post">
	...
	<label for="anum">Annual Income</label>
             <input type="text" id="annual" name="annual" >  
